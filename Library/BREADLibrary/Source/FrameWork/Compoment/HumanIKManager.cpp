...
namespace Bread {
	namespace FrameWork {
		...
		{
			void HumanCCDIKManager::Start()
			{

			}//Start

			void HumanCCDIKManager::Update()
			{
				//LookAt
			...
			void HumanCCDIKManager::HoldHand(std::shared_ptr<HoldHandSetup> holdHand)
			{
			...
			void HumanCCDIKManager::HumanLookAt(std::shared_ptr<LookAtSetup> lookAt)
			{
			...
			void HumanCCDIKManager::LookAtNode(std::shared_ptr<LookAtSetup> lookAt, const Vector3& targetPos, const float& rate)
			{
			...
			void HumanCCDIKManager::LookAtParentRotation(std::shared_ptr<LookAtSetup> lookAt, float rate)
			{
			...
			void HumanCCDIKManager::FootIk(std::shared_ptr<FootIkSetUp> footIk)
			{
			...
			bool HumanCCDIKManager::UpdateAnklesTarget(std::shared_ptr<HumanCCDIKManager::FootIkSetUp> footIk) {
				for (u32 i = 0; i < FootNum; i++)
				{
			...
			bool HumanCCDIKManager::UpdatePelvisOffset(std::shared_ptr<HumanCCDIKManager::FootIkSetUp> footIk) {
			...
			void HumanCCDIKManager::RegisterHoldHand(std::shared_ptr<ModelObject> follower, std::shared_ptr<ModelObject> leader)
			{
			...
			void HumanCCDIKManager::UnRegisterHoldHand(std::shared_ptr<HumanCCDIKManager::HoldHandSetup> follower)
			{
			...
			void HumanCCDIKManager::RegisterLookAt(std::shared_ptr<ModelObject> model, Vector3* targetPos, bool* flg)
			{
			...
			void HumanCCDIKManager::UnRegisterLookAt(std::shared_ptr<LookAtSetup> lookAt)
			{
			...
			void HumanCCDIKManager::RegisterFootIk(std::shared_ptr<ModelObject> model, std::shared_ptr<Transform> rootT, const std::shared_ptr<RayCastCom> rayCast[2])
			{
				if (!model)//ModelComponentが無い場合早期リターン
				{
					return;
			...
			void HumanCCDIKManager::UnRegisterFootIk(std::shared_ptr<FootIkSetUp> footIk)
			{
			...
			void HumanCCDIKManager::Gui()
			{
				ImGui::Begin("HumanCCDIKManager");
